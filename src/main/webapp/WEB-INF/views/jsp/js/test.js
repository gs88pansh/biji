...
var $bijiPoker = document.createElement('button')
...
$bijiPoker.textContent = 'BijiPoker'
...
$topbar.appendChild($bijiPoker)

var deck = bijiDeck(5,document.body,false)
...
$bijiPoker.addEventListener('click', function () {
  deck.shuffle()
  deck.shuffle()
  deck.shuffle()
  deck.bijiPoker()
