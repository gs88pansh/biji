...
public class Sta1 {
    ...
    public static void main(String[]args) throws Exception {
    	...
    	for(int K=3;K<=7;K++) {
	    	...
	    	str += Constance.typeStr[5]+":"+ df.format((double)Constance.san_ge_tou_num*(double)100 / (double)(total*K)) + "%\n";
	    	str += Constance.typeStr[4]+":"+ df.format((double)Constance.shun_qing_num*(double)100 / (double)(total*K)) + "%\n";
	    	str += Constance.typeStr[3]+":"+ df.format((double)Constance.jin_hua_num*(double)100 / (double)(total*K)) + "%\n";
	    	str += Constance.typeStr[2]+":"+ df.format((double)Constance.tuo_la_ji_num*(double)100 / (double)(total*K)) + "%\n";
	    	str += Constance.typeStr[1]+":"+ df.format((double)Constance.dui_zi_num*(double)100 / (double)(total*K)) + "%\n";
	    	str += Constance.typeStr[0]+":"+ df.format((double)Constance.dan_zhi_zi_num*(double)100 / (double)(total*K)) + "%\n";
